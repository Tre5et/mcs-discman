...
public class RunCommandCommand extends Command<CommandConfig.RunCommand> {
    ...
    @Override
    protected void process(SlashCommandInteraction interaction, CommandConfig.RunCommand function) {
        String cmd = Objects.requireNonNull(interaction.getOption("command")).getAsString();
    ...
    public CommandData data() {
        return Commands.slash("runcommand", "Run a command on the server! [Moderator only]")
