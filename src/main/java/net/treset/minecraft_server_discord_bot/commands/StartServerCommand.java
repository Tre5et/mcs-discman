...
public class StartServerCommand extends Command<FunctionConfig.Start> {
    public StartServerCommand(Supplier<FunctionConfig.Start> configSupplier) {
        super(configSupplier);
    }

    @Override
    protected void process(SlashCommandEvent event, FunctionConfig.Start function) {
