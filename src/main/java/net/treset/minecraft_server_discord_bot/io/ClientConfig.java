...
public class ClientConfig {
    ...
    public boolean ADVANCEMENT_LOGGING;
    ...
    public ClientConfig(String source) {
        ...
        this.ADVANCEMENT_LOGGING = FormatTools.stringToBoolean(ConfigTools.findConfigOption(source, "advancement_logging", false, true));
